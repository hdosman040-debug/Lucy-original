...
export function RoomsSection() {
  ...
  return (
    <section id="rooms" className="bg-[#FAFAFA] border-t border-[#E2D6BC]/30 py-28">
              ...
              >
                <article className="group flex h-full flex-col overflow-hidden rounded-none border border-[#E2D6BC]/50 bg-white shadow-[0_4px_25px_rgba(15,42,67,0.02)] transition-all duration-500 hover:-translate-y-1.5 hover:shadow-[0_20px_40px_rgba(15,42,67,0.08)]">
                  ...
                  <div className="relative overflow-hidden bg-[#0F2A43]">
                    ...
                    />
                    {/* Editorial Pricing Sticker */}
                    <span className="absolute right-0 bottom-0 bg-[#0F2A43] border-t border-l border-[#C9A227]/30 px-5 py-2.5 text-[0.68rem] font-semibold uppercase tracking-[0.2em] text-[#F3E9D2]">
                  ...
                  <div className="flex flex-1 flex-col p-6 sm:p-8">
                    <div className="flex items-baseline justify-between border-b border-[#E2D6BC]/20 pb-4">
                      <h3 className="font-serif text-2xl font-medium tracking-wide text-[#0F2A43]">
                        {info.name}
                      </h3>
                      <span className="flex items-center gap-1.5 text-xs font-semibold tracking-wider text-[#C9A227] uppercase">
                        <Users className="h-3.5 w-3.5" />
                        {room.guests} {t.booking.guestsLabel}
                      </span>
                    </div>

                    <p className="mt-4 flex-1 text-sm font-light leading-relaxed text-[#1E252D]/85">
                      {info.desc}
                    </p>
