          ...
          {items.map(({ key, Icon }, i) => {
            ...
            return (
              <AnimatedSection key={key} delay={i * 70}>
                <div className="group flex h-full flex-col items-center bg-[#FAFAFA] border border-[#E2D6BC]/40 p-12 text-center transition-all duration-500 hover:bg-white hover:border-[#C9A227]/50 hover:shadow-[0_20px_40px_rgba(15,42,67,0.05)]">
